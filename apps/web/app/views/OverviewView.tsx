...
export function OverviewView({data,k,baseline,top,setView,ask}:OverviewProps){
  return <>
    <section className="hero-grid">
      ...
      <Card label="Operating cost" value={k.operating_cost_cad_m2} unit="CAD/m²·day" meta={data.tariff.configured?"Open Energy for Ontario interval cost by on/mid/off-peak period":"Configure Ontario tariffs to enable cost"} tone="neutral"/>
    </section>
